...
const Sidebar = ({ currentPage, onNavigate, isCollapsed, setIsCollapsed, hasPendingApproval, pendingApprovalByGroup = {} }) => {
  ...
  return (
    ...
    >
      ...
      {!isCollapsed && (
        <div className="h-24 p-3 border-b border-gray-100">
          <div className="h-full rounded-lg bg-gradient-to-br from-green-50 via-white to-emerald-50 border border-green-100/80 p-3 shadow-sm">
      ...
      {isCollapsed && (
        <div className="h-24 p-2 border-b border-gray-100">
          <button
